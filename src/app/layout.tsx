...
export const metadata: Metadata = {
  title: "SaaS Pro - Intelligent Business Automation Platform",
  description: "Transform your business with SaaS Pro. Automate workflows, increase productivity, and scale effortlessly. Start your 14-day free trial today.",
  keywords: "saas software, business automation, workflow automation, productivity tools, team collaboration",
  metadataBase: new URL("https://saaspro.com"),
  alternates: {
    canonical: "https://saaspro.com"
  },
  openGraph: {
    title: "SaaS Pro - Intelligent Business Automation",
    description: "Transform your business with powerful automation tools. 14-day free trial, no credit card required.",
    siteName: "SaaS Pro",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763828202874-v4ord9we.jpg",
      alt: "SaaS Pro Platform"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "SaaS Pro - Business Automation Made Simple",
    description: "Automate workflows and boost productivity. Start free today.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763828202874-v4ord9we.jpg"]
  },
  robots: {
    index: true,
    follow: true
